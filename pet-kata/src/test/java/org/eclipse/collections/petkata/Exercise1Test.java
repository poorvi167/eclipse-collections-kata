...
public class Exercise1Test extends PetDomainForKata
{
    ...
    public void getNamesOfMarySmithsPets()
    {
        ...
        // Replace null, with a transformation method on MutableList.
        MutableList<String> names = pets.select(people -> person.named("Mary Smith"))
                .collect(Pet::getName); // pets...
    ...
    public void getPeopleWithCats()
    {
        ...
        MutableList<Person> peopleWithCats = this.people.select(person -> person.hasPet(PetType.CAT));  // this.people...
